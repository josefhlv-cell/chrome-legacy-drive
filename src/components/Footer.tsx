      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <div className="flex flex-col gap-3 text-sm text-muted-foreground font-montserrat">
            <p className="font-semibold text-foreground text-xs uppercase tracking-wider mb-1">Prodej a výkup vozidel</p>
            <div className="flex items-center gap-2"><Phone className="w-4 h-4 text-primary" /> +420 603 559 767</div>
            <p className="font-semibold text-foreground text-xs uppercase tracking-wider mb-1 mt-2">Prodej nových autodílů</p>
            <div className="flex items-center gap-2"><Phone className="w-4 h-4 text-primary" /> +420 737 842 460</div>
            <p className="font-semibold text-foreground text-xs uppercase tracking-wider mb-1 mt-2">Prodej použitých autodílů</p>
            <div className="flex items-center gap-2"><Phone className="w-4 h-4 text-primary" /> +420 603 372 911</div>
            <p className="font-semibold text-foreground text-xs uppercase tracking-wider mb-1 mt-2">Autoservis</p>
            <div className="flex items-center gap-2"><Phone className="w-4 h-4 text-primary" /> +420 603 559 767</div>
