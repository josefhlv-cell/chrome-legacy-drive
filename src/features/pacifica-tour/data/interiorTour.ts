...
const FinishKey = ({
  ...
  return (
    <div className="pointer-events-auto absolute bottom-24 right-4 z-40 flex flex-col items-end sm:bottom-8 sm:right-8">
      <div
        className="
          mb-2
          whitespace-nowrap
      ...
      <div className="relative h-[150px] w-[96px] sm:h-[175px] sm:w-[112px]">
        <img
          src={KEY_ASSET}
          alt="Klíč od vozu"
          draggable={false}
          className="
            ...
            w-full
            object-contain
            drop-shadow-[0_15px_30px_rgba(0,0,0,0.7)]
          "
        />
        ...
        >
          ...
          <span
            className="
              ...
              border-primary
              bg-primary/15
              shadow-[0_0_24px_hsl(var(--primary))]
            "
          />
...
/* -------------------------------------------------------------------------- */
/* INFO CARD — VŽDY KOMPLETNĚ ROZBALENÁ                                     */
/* -------------------------------------------------------------------------- */
...
const PhotoStep = ({
  ...
  useEffect(() => {
    /*
     * KAŽDÝ fotografický krok má vlastní intro kartu.
     *
     * Pokud intro existuje, otevře se automaticky.
     * Není potřeba kliknout na hotspot.
     */
  ...
  const pick = useCallback(
    (hotspot: PhotoHotspot) => {
      if (hotspot.card) {
        /*
         * Hotspot s kartou otevře kartu rovnou kompletně.
         *
         * Žádný expanded state.
         * Žádné collapsible.
         */
...
const VideoStep = ({
  ...
  return (
    <>
      ...
      {/* KARTA VIDEA JE VIDITELNÁ OD ZAČÁTKU */}
      <InfoCard
        card={step.card}
        onClose={() => undefined}
      />
