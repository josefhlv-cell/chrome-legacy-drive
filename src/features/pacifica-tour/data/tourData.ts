...
export type HotspotDetail = {
  ...
  media?: HotspotMedia;
  /** Volitelná akce karty — např. přechod do interiérové části prohlídky. */
  cta?: { label: string; action: "interior" };
  /** Doplňková poznámka (výbava vozu). */
  note?: string;
};
...
export const HOTSPOTS: TourHotspot[] = [
  {
    ...
    detail: {
      ...
      text: "Detail předního světlometu konkrétního vozu. Na fotografii je patrné pouzdro světlometu s výraznou světelnou grafikou a integrovaným směrovým světlem.",
      bullets: [
  ...
  },
  {
    ...
    detail: {
      ...
      text: "Detail kola konkrétního vozu. Na fotografii je vidět lehký slitinový ráfek s vícepaprskovým designem, středová krytka se znakem Chrysler a pneumatika s vyšším profilem.",
      bullets: [
  ...
  },
  {
    ...
    detail: {
      ...
      text: "Pod kapotou je benzinový šestiválec 3.6 litru s výkonem 287 koní (211 kW) a točivým momentem 262 lb-ft. Přenos výkonu zajišťuje 9stupňová automatická převodovka. U AWD verze umí systém pohonu poslat až 100 % momentu na zadní nápravu, když přední kola ztrácí trakci.",
      bullets: [
  ...
  },
  {
    ...
    detail: {
      ...
      text: "Praktické řešení pro pohodlný nástup cestujících a snadný přístup do druhé řady. Konkrétní způsob ovládání a dostupné funkce závisí na výbavě vozu.",
      bullets: [
