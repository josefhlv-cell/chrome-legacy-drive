...
const PROMPT = [
  ...
  "ABSOLUTE GEOMETRY RULES — these coordinates override aesthetics:",
  "1) Output canvas is exactly 1920x1080. Treat the asphalt floor as the lower part of the background. The vehicle must be placed LOW on this asphalt floor, not in the middle of the wall.",
  "2) The car bounding box must be horizontally centered: bbox center x = 960 px, equal empty space left and right.",
  "3) The bottom tire contact line must be y = 1020–1035 px, leaving only 45–60 px below the tires. Do NOT place the tires at y=820, y=860, y=900, or anywhere high on the back wall.",
  "4) ALL visible tires/wheels must touch the asphalt floor on that same y=1020–1035 baseline. Wheels must NEVER touch or overlap the wall, the logo, the ceiling, the columns or any vertical surface.",
  "5) Scale target: normal cars/minivans should be about 1150–1350 px wide and 420–560 px tall. Absolute max height is 70% of image height. If taller, shrink proportionally. Never crop the car.",
  "6) The roof, bumpers and all wheels must remain fully visible. The vehicle must look like a real photo taken inside this showroom from a slight front-3/4 angle.",
