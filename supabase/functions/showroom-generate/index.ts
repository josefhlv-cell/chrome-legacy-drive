...
const PROMPT = [
  ...
  "3) Output canvas is exactly 1920x1080. Put the vehicle LOW on the asphalt floor, like a real dealer photo, not high on the wall.",
  "4) Target car bounding box: approximately x=300 to x=1840, bottom tire contact line y=1015–1030, roof around y=360–430 for normal minivans/cars. This means the car fills about 78–82% of image width and sits close to the bottom with only about 50–65 px under the tires.",
  "5) The visual center of the car should be slightly right of canvas center, around x=1050–1080, matching the supplied placement style. Do not push the car into the wall/logo area; keep it fully on the asphalt.",
  "6) ALL visible tires/wheels must touch the asphalt floor on the same y=1015–1030 baseline. Wheels must NEVER touch or overlap the wall, the logo, the ceiling, the columns or any vertical surface.",
  "7) The roof, bumpers, mirrors and all wheels must remain fully visible. Never crop the car. Never make the car tiny. Never place the car in the middle of the wall.",
